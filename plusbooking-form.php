...
<body>
  <div class="container">
    ...
    if (isset($_GET['movie_id']) && isset($_GET['theater_name']) && isset($_GET['showtime']) && isset($_GET['date'])) {
      ...
      echo "<p class='gold'>Gold: Rs 160</p>";
      echo "<p class='silver'>Silver: Rs 120</p>";
      echo "<p class='bronze'>Bronze: Rs 100</p>";
      echo "<p></p>";
      ...
      if (isset($_POST['card_holder_name']) && isset($_POST['card_number']) && isset($_POST['expiry_month']) && isset($_POST['expiry_year']) && isset($_POST['cvv'])) {
        ...
        if ($cardResult->num_rows > 0) {
          ...
          if ($balance >= $totalPrice) {
            ...
            echo "<script>setTimeout(function(){ window.location.href = 'http://localhost/ticketflix/home.php'; }, 5000);</script>";
          } else {
